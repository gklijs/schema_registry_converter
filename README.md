...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", features = ["avro"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", features = ["easy", "avro"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", default-features = false, features = ["avro", "blocking"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", features = ["avro", "blocking"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", features = ["proto_raw"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.1", features = ["easy", "proto_raw"] }
```
