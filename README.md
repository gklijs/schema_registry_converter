...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", features = ["avro"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", features = ["easy", "avro"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", default-features = false, features = ["avro", "blocking"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", features = ["avro", "blocking"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", features = ["proto_raw"] }
```
...
```toml
[dependencies]
schema_registry_converter = { version = "4.6.0", features = ["easy", "proto_raw"] }
```
